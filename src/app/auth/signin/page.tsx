  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1F4E79] to-[#2E75B6] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-1">フォームアプローチ</h1>
        <p className="text-gray-500 text-sm mb-8">チームメンバー専用ツール</p>
        ...
        <p className="text-xs text-gray-400 mt-6">許可されたメールアドレスのみアクセス可能です</p>
      </div>
    </div>
  )
}
